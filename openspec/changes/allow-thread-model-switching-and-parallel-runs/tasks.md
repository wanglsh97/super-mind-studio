...
- [x] 1.2 扩展 API mapper、SDK types 和管理员/分析读取边界，返回 Run 模型快照且不改变现有实际 invocation 归因
- [x] 1.3 将 `AGENT_MAX_CONCURRENT_RUNS_PER_USER` 默认值从 3 调整为 5，同步 `.env.example`、配置校验测试和部署说明
